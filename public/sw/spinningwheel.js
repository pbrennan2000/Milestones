...
var SpinningWheel = {
	...
	create: function () {
		...
		div.id = 'sw-wrapper';
		div.style.top = window.innerHeight + window.pageYOffset + 'px !important';		// Place the SW down the actual viewing screen
		div.style.webkitTransitionProperty = '-webkit-transform !important';
